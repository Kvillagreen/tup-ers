...
$pdf->SetFont('Arial', '', 14);
$pdf->setX(25);
$pdf->MultiCell(0, 5, "That we are aware of the provision of Item 1.0 of TUP Order No. 19, s. 2019 which states 'Special classes are off semester/term courses which are not offered in the current semester or term for which they are petitioned';", );
...
$pdf->SetFont('Arial', '', 14);
$pdf->setX(25);
$pdf->MultiCell(0, 5, "That we are aware of the Item 4.0 of TUP Order which states “ The special class as much as possible, be included in the regular load of the faculty, but may be considered as a part-time load at the discretion of the Dean taking into consideration the part-time rate of the faculty, the schedule, and similar factors';", );
$pdf->Ln(5);
...
$pdf->SetFont('Arial', '', 14);
$pdf->setX(25);
$pdf->MultiCell(0, 5, "That we are also aware of Item 5.0 of the same Order which states 'Regular tuition fees shall be paid by the students in the special class but only for the special class involved and that the petitioning students shall sign an undertaking for the voluntary payment of the tuition fee based on the existing per unit charge of the University. The miscellaneous fees of the students shall be submitted to the UNIFAST for refund';", );
...
$pdf->SetFont('Arial', '', 14);
$pdf->setX(25);
$pdf->MultiCell(0, 5, "That in view of Items 4.0 and 5.0 of the foregoing TUP Order, we student-petitioners voluntarily submit ourselves to pay the tuition fee and to pay also the honoraria of the faculty handling the special class if this special class is not part of the regular load of the faculty involved.\n\n\n\n\n\n\n\n\n", );
$pdf->Ln(5);
...
$pdf->SetFont('Arial', '', 14);
$pdf->setX(37);
$pdf->MultiCell(0, 7, "this ________ day of _______________ at the City of Talisay, 
...
RE:           REQUEST FOR APPROVAL OF SPECIAL CLASS
_________________________________________________________________
");
